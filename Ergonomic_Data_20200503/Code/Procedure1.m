...
clear all
clc
left =  readtable('/Users/zhenhu/Documents/Second_semester/CIS/Raw_Data_20200503/Procedure1.csv');
left = [left(:,1:3) left(:,13:19)];
...
start_A6_Euler = [3.2031, 46.7407, -111.8114];
start_A1_Euler = [82.5170, 2.5345, -9.0866];
%% Separate the A6 and A1 data
%left = sortrows(left,1);
%left = [left(:,1:3) left(:,13:19)];

...
circle =  readtable('/Users/zhenhu/Documents/Second_semester/CIS/Mock OR/circle.csv');
...
circle = sortrows(circle,1);
circle = [circle(:,1:3) circle(:,13:19)];
circle = table2array(circle);

A6 = circle(circle(:,1)==1,:);
A1 = circle(circle(:,1)==2,:);

...
updown =  readtable('/Users/zhenhu/Documents/Second_semester/CIS/Mock OR/updown.csv');
...
updown = sortrows(updown,1);
updown = [updown(:,1:3) updown(:,13:19)];
updown = table2array(updown);

A6 = updown(updown(:,1)==1,:);
A1 = updown(updown(:,1)==2,:);

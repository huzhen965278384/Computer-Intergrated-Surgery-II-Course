...
shoulder =  readtable('/Users/zhenhu/Documents/Second_semester/CIS/Mock OR/shoulder.csv');
...
shoulder = sortrows(shoulder,1);
shoulder = [shoulder(:,1:3) shoulder(:,13:19)];
shoulder = table2array(shoulder);

A6 = shoulder(shoulder(:,1)==1,:);
A6 = A6(1:end-1,:);
A1 = shoulder(shoulder(:,1)==2,:);
